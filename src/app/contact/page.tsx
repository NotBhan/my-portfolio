      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pb-12">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="bento-card p-8 bg-primary/5 border-primary/10 relative overflow-hidden group">
            ...
            <h2 className="text-2xl font-black text-foreground uppercase tracking-tight mb-4">Direct Channel</h2>
            ...
            <div className="space-y-4">
              <a href={`mailto:${profile.email}`} className="flex items-center gap-4 p-4 rounded-2xl bg-card border border-border hover:border-primary/30 transition-all group">
                ...
                <div className="overflow-hidden">
                  ...
                  <span className="block text-sm text-foreground font-medium truncate">{profile.email}</span>
                </div>
              </a>

              <a href={profile.linkedin} target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 rounded-2xl bg-card border border-border hover:border-primary/30 transition-all">
                ...
                <div>
                  ...
                  <span className="block text-sm text-foreground font-medium">Professional Profile</span>
                </div>
              </a>

              <a href={profile.github} target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 rounded-2xl bg-card border border-border hover:border-primary/30 transition-all">
                ...
                <div>
                  ...
                  <span className="block text-sm text-foreground font-medium">Source Collections</span>
                </div>
              </a>
            </div>
          </div>
        ...
        <div className="lg:col-span-7">
          <div className="bento-card p-8 bg-card/50 h-full">
            <div className="flex items-center gap-2 mb-8">
              <MessageSquare size={16} className="text-primary" />
              <h2 className="text-sm font-black text-foreground uppercase tracking-[0.2em]">Send a Transmission</h2>
            </div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input className="bg-muted/20 border-border rounded-xl h-12 focus:border-primary/40 focus:ring-0 text-foreground" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest ml-1">Email Address</label>
                  <Input className="bg-muted/20 border-border rounded-xl h-12 focus:border-primary/40 focus:ring-0 text-foreground" type="email" placeholder="john@example.com" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest ml-1">Message Body</label>
                <Textarea className="bg-muted/20 border-border rounded-xl min-h-[160px] focus:border-primary/40 focus:ring-0 text-foreground resize-none" placeholder="What's on your mind?" />
              </div>
